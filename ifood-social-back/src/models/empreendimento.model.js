...
class EmpreendimentoModel {
  ...
  async findById(id) {
    const rows = await connection.query('SELECT * FROM EMPREENDIMENTO WHERE COD_EMPREEDIMENTO = ?', [id]);
